...
public class Restaurants {
    ...
    public Restaurants(int restId, String restName, String restEmail, String restPassword, String restOwnerType, int restPhone, String restAddress, String restAccountStatus, byte[] restImage, double restRating, String restStatus, String restOpeningTime, String restClosingTime) {
        this.restId = restId;
    ...
    public Restaurants(int restId, String restName, String restEmail, String restPassword, String restOwnerType, int restPhone, String restAddress, String restAccountStatus, byte[] restImage, double restRating, String restStatus, String restOpeningTime, String restClosingTime, double foodPrice) {
        this.restId = restId;
        this.restName = restName;
        this.restEmail = restEmail;
        this.restPassword = restPassword;
