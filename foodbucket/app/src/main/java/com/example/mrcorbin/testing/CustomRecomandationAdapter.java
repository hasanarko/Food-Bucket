...
public class CustomRecomandationAdapter extends BaseAdapter {
    ...
    public CustomRecomandationAdapter(List<Restaurants> res, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.recomandationlist_sample_view, parent, false);
        }

        ImageView imageView = convertView.findViewById(R.id.recomand_rest_image);
        TextView textView_restaurant_title = convertView.findViewById(R.id.recomand_rest_name);
        TextView textView_rest_address = convertView.findViewById(R.id.recomand_rest_address);
        TextView textView_rest_rating = convertView.findViewById(R.id.recomand_rest_rating);
